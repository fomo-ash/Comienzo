...
<h1 className="text-6xl md:text-7xl font-extrabold tracking-widest text-[#2f2b2b] drop-shadow-sm">COMIENZO</h1>
...
<p className="mt-6 text-center text-lg md:text-xl font-medium text-[#334444]"></p>
</div>
</div>
</section>
);
